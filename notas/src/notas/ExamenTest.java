...
public class ExamenTest {
	...
	/** PREGUNTAS_TOTALES establece el número de preguntas que tnedrá un examen tipo test. */
    ...
    /**
     * Constructor que calcula la nota de los parámetros recibidos cuando se agrega un alumno manualmente
     *
     * @param aciertos
     * @param fallos
