...
/**
 * Hereda de la clase Pestanya, es un panel dentro de los tabs que mostrará información de las notas finales.
 */
public class NotasFinales extends Pestanya {
	...
	/**
	 * Recibe los datos correspondientes a las notas finales y llama al constructor de la clase padre donde creará la tabla con los datos recibidos.
	 *
	 * @param trabajos String array con algunos datos del alumno y con datos de los examenes clásicos
