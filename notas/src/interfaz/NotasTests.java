...
/**
 *  Hereda de la clase Pestanya, es un panel dentro de los tabs que mostrará información de las notas de tipo test.
 */
public class NotasTests extends Pestanya {
	...
	/**
	 * Recibe los datos correspondientes a las notas de tipo test y llama al constructor de la clase padre donde creará la tabla con los datos recibidos.
	 *
	 * @param examenesTests String array con algunos datos del alumno y con datos de los examenes clásicos
