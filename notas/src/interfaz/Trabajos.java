...
/**
 * Hereda de la clase Pestanya, es un panel dentro de los tabs que mostrará información de los trabajos.
 */
public class Trabajos extends Pestanya {
	...
	/**
	 * Recibe los datos correspondientes a los trabajos y llama al constructor de la clase padre donde creará la tabla con los datos recibidos.
	 *
